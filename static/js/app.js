...
const NAV_ICONS={
    ...
    'pvp.svg':{
        outline:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="white" stroke-opacity="0.64" stroke-width="1.8"/><circle cx="12" cy="12" r="6" stroke="white" stroke-opacity="0.4" stroke-width="1" stroke-dasharray="3 2.5"/><path d="M7.5 5.5 A8 8 0 0 1 18.5 9" stroke="#FF6B35" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M18.5 15 A8 8 0 0 1 7.5 18.5" stroke="#4ECDC4" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M5.5 16.5 A8 8 0 0 1 5.5 7.5" stroke="#A855F7" stroke-width="2" stroke-linecap="round" fill="none"/><circle cx="12" cy="12" r="2" fill="white" fill-opacity="0.64"/></svg>',
        filled:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="white" stroke-width="1.8"/><circle cx="12" cy="12" r="6" stroke="white" stroke-opacity="0.5" stroke-width="1" stroke-dasharray="3 2.5"/><path d="M7.5 5.5 A8 8 0 0 1 18.5 9" stroke="#FF6B35" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M18.5 15 A8 8 0 0 1 7.5 18.5" stroke="#4ECDC4" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M5.5 16.5 A8 8 0 0 1 5.5 7.5" stroke="#A855F7" stroke-width="2.5" stroke-linecap="round" fill="none"/><circle cx="12" cy="12" r="2.5" fill="white"/></svg>'
    }
};
