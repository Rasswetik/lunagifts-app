"""Upload scratch GIFs to server with robust SFTP."""
import paramiko, os, json, urllib.request, time
...
gifs = [f'static/gifs/scratch/moon{s}.gif' for s in [''] + list(range(1, 13))]
